          ...
          <div className="hidden md:flex space-x-8">
            {["Home", "About", "Themes", "Submission Guidelines", "Problem Statements", "FAQs", "Contact Us"].map(
              (item) => (
                <Link
                  key={item}
                  href={item === "Contact Us" ? "/contact" : item === "Submission Guidelines" ? "faqs/submissionGuidelinesSDI.pdf" : item === "Problem Statements" ? "/problem-statements" : item === "FAQs" ? "faqs/HACKATHON FAQ.pdf" : item === "Home" ? "/" : `/#${item.toLowerCase().replace(" ", "-")}`}
